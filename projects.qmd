...
## Spatially-resolved multi-omics in neurobiology
...
-   Huuki-Myers L, Spangler A, Eagles N, Montgomery KD, Kwon SH, **Guo B**, Grant-Peters M, Divecha HR, Tippani M, Sriworarat C, Nguyen AB, Ravichandran P, Tran MN, Seyedian A, Hyde TM, Kleinman JE, Battle A, Page SC, Ryten M, Hicks SC, Martinowich K, Collado-Torres L, Maynard KR. (2024). [A data-driven single-cell and spatial transcriptomic map of the human prefrontal cortex.](https://www.science.org/doi/10.1126/science.adh1938). _Science_.

- **Guo B**$^+$, Ling W$^+$, Kwon SH, Panwar P, Ghazanfar S, Martinowich K, Hicks SC. (2025). [Integrating spatially-resolved transcriptomics data across tissues and individuals: challenges and opportunities](https://onlinelibrary.wiley.com/doi/full/10.1002/smtd.202401194) _Small Methods_ 
...
* Totty M$^*$, Hicks SC, **Guo B**. (2025) [SpotSweeper: Spatially aware quality control metrics for spatially resolved transcriptomics data](https://www.nature.com/articles/s41592-025-02713-3). _Nature Methods_. 

* Shah KH$^*$, **Guo B**, Hicks SC. (2025)  [Addressing the mean-variance relationship in spatially resolved transcriptomics data with spoon](https://academic.oup.com/biostatistics/article/26/1/kxaf012/8162634). __Biostatistics__.

* Zhou H$^*$, Panwar P, **Guo B**, Hallinan C, Ghazanfar S, and Hicks SC. (2025) [Spatial mutual nearest neighbors for spatial transcriptomics data.](https://academic.oup.com/bioinformatics/article/41/8/btaf403/8214008) _Bioinformatics_. 
