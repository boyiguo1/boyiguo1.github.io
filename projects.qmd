...
### Computational methods processing, integrating analyzing and visualizing spatial genomics data
<div>
<div style="float: left; position: relative; top: 0px; padding: -10px;">
![Multi-dimensional *in situ* visualization (Guo et al., 2023)](img/insitu.jpg){width=60%}
</div>
